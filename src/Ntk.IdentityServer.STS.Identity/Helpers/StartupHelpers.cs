...
using Ntk.IdentityServer.STS.Identity.Configuration;
using Ntk.IdentityServer.STS.Identity.Configuration.ApplicationParts;
using Ntk.IdentityServer.STS.Identity.Configuration.Constants;
using Ntk.IdentityServer.STS.Identity.Configuration.Interfaces;
using Ntk.IdentityServer.STS.Identity.Helpers.Localization;

namespace Ntk.IdentityServer.STS.Identity.Helpers
{
