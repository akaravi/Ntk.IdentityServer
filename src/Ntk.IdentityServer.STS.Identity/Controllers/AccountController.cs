...
using Ntk.IdentityServer.STS.Identity.Helpers;
using Ntk.IdentityServer.STS.Identity.Helpers.Localization;
using Ntk.IdentityServer.STS.Identity.ViewModels.Account;

namespace Ntk.IdentityServer.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
