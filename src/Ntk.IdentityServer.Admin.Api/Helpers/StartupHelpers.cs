...
using Ntk.IdentityServer.Admin.Api.Configuration;
using Ntk.IdentityServer.Admin.Api.Configuration.ApplicationParts;
using Ntk.IdentityServer.Admin.Api.Configuration.AuditLogging;
using Ntk.IdentityServer.Admin.Api.Configuration.Constants;
using Ntk.IdentityServer.Admin.Api.Helpers.Localization;
...
namespace Ntk.IdentityServer.Admin.Api.Helpers
{
