...
using Ntk.IdentityServer.Shared.Configuration.Configuration.Email;
using Ntk.IdentityServer.Shared.Configuration.Email;

namespace Ntk.IdentityServer.Shared.Configuration.Helpers
{
