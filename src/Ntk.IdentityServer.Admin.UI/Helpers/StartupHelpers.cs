...
using Ntk.IdentityServer.Admin.BusinessLogic.Identity.Dtos.Identity;
using Ntk.IdentityServer.Admin.BusinessLogic.Services;
using Ntk.IdentityServer.Admin.BusinessLogic.Services.Interfaces;
using Ntk.IdentityServer.Admin.EntityFramework.Configuration.Configuration;
using Ntk.IdentityServer.Admin.EntityFramework.Configuration.MySql;
using Ntk.IdentityServer.Admin.EntityFramework.Configuration.PostgreSQL;
using Ntk.IdentityServer.Admin.EntityFramework.Configuration.SqlServer;
using Ntk.IdentityServer.Admin.EntityFramework.Helpers;
using Ntk.IdentityServer.Admin.EntityFramework.Interfaces;
using Ntk.IdentityServer.Admin.EntityFramework.Repositories;
using Ntk.IdentityServer.Admin.EntityFramework.Repositories.Interfaces;
using Ntk.IdentityServer.Admin.UI.Configuration;
using Ntk.IdentityServer.Admin.UI.Configuration.ApplicationParts;
using Ntk.IdentityServer.Admin.UI.Configuration.Constants;
using Ntk.IdentityServer.Admin.UI.ExceptionHandling;
using Ntk.IdentityServer.Admin.UI.Helpers.Localization;
using Ntk.IdentityServer.Admin.UI.Middlewares;
using Ntk.IdentityServer.Shared.Configuration.Authentication;

namespace Ntk.IdentityServer.Admin.UI.Helpers
{
